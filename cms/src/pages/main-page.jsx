...
const timing = {
	stream: { label: "Трансляция" },
	videos: { label: "Поздравления" },
	startVote: { label: "Начало голосования" },
	finishVote: { label: "Конец голосования" },
	raffle: { label: "Трансляция розыгрыша" },
	winner: { label: "Победители по м. жюри" },
	awards: { label: "Приз зрит. симпатий" }
}
